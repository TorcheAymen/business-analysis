    ...
    <div className="flex flex-col items-center">
      ...
      <div className="a4-page overflow-hidden font-['Inter'] flex flex-col">
        ...
        <div className="grid grid-cols-12 gap-8 flex-1">
          ...
          <div className="col-span-7 space-y-8 border-l border-slate-100 pl-8">
            
            {/* Parcours & Impact (Split into 3 paragraphs) */}
            <section>
            ...
            {/* Objectifs & Frustrations - Exact Content */}
            ...
            {/* Critères de Valeur - Exact Content */}
